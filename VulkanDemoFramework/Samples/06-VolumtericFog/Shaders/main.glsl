...
void main() {
    ...
    // NOTE: assume texcoords are always specified for now
...
void main() {
    ...
    if ( (flags & DrawFlags_HasTangents) == 0 ) {
        ...
        // NOTE: code taken from https://github.com/KhronosGroup/glTF-Sample-Viewer
    ...
    if (phong) {
        // TODO: we assume we use this shader only for the transparent pass
